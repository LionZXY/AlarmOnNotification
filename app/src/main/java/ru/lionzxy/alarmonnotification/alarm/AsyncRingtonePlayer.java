...
import ru.lionzxy.alarmonnotification.R;
...
public final class AsyncRingtonePlayer {
    ...
    private static float computeVolume(long currentTime, long stopTime, long duration) {
        ...
        Log.v("AsyncRingtonePlayer", String.format("Ringtone crescendo %,.2f%% complete (scalar: %f, volume: %f dB)",
    ...
    private class MediaPlayerPlaybackDelegate implements PlaybackDelegate {
        ...
        public boolean play(final Context context, Uri ringtoneUri, long crescendoDuration) {
            ...
            if (alarmNoise == null) {
                ...
                Log.v("AsyncRingtonePlayer", "Using default alarm: " + alarmNoise.toString());
            }
            ...
            try {
                ...
                Log.e("AsyncRingtonePlayer", "Using the fallback ringtone, could not play " + alarmNoise, t);
                ...
                try {
                    ...
                    Log.e("AsyncRingtonePlayer", "Failed to play fallback ringtone", t2);
                }
            }
        ...
        public boolean adjustVolume(Context context) {
            ...
            Log.i("AsyncRingtonePlayer", "MediaPlayer volume set to " + volume);
    ...
    private class RingtonePlaybackDelegate implements PlaybackDelegate {
        ...
        private RingtonePlaybackDelegate() {
            try {
                ...
                Log.e("AsyncRingtonePlayer", "Unable to locate method: Ringtone.setVolume(float).", nsme);
            }

            try {
                mSetLoopingMethod = Ringtone.class.getDeclaredMethod("setLooping", boolean.class);
            } catch (NoSuchMethodException nsme) {
                Log.e("AsyncRingtonePlayer", "Unable to locate method: Ringtone.setLooping(boolean).", nsme);
            }
        }
        ...
        public boolean play(Context context, Uri ringtoneUri, long crescendoDuration) {
            ...
            try {
                ...
                Log.e("AsyncRingtonePlayer", "Using the fallback ringtone, could not play " + ringtoneUri, t);
